<div style="width: 100%; height: auto; margin-top: 2px; ">
	...
	?>
	<div style="margin-top: 60px; max-width: 100%; width: auto; height: auto; float: left;" class="private_chats_container" id="private_chats_container">
	...
	?>
	<div style="margin-top: 60px; max-width: 100%; width: auto; height: auto; float: left; " class="public_chats_container" id="public_chats_container">
